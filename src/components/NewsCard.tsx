export default function NewsCard({ title, category, image }: { title: string, category: string, image: string }) {
  return (
    <div className="group cursor-pointer">
      ...
      <div>
        ...
        <p className="mt-3 text-slate-500 text-sm line-clamp-2 italic">
          Clique para ler o conteudo completo desta materia exclusiva...
        </p>
      </div>
    </div>
  );
